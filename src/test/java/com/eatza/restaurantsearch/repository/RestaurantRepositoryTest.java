...
public class RestaurantRepositoryTest {
	...
	public void findByLocationContainingAndCuisineContaining() {
		Pageable pageable = PageRequest.of(1, 10);
		Page<Restaurant> restaurants = restaurantRepository.findByLocationContainingAndCuisineContaining("rr",
				"Soprole", pageable);
		assertEquals(1, restaurants.getTotalElements());
	}
	...
	public void findByLocationContainingAndNameContaining() {
		Pageable pageable = PageRequest.of(1, 10);
		Page<Restaurant> restaurants = restaurantRepository.findByLocationContainingAndNameContaining("rr", "dominos",
				pageable);
